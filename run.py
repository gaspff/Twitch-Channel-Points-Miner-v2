...
twitch_miner = TwitchChannelPointsMiner(
    username="sheeeeeeshbaby",
    password="BtrA45172:!",           # If no password will be provided, the script will ask interactively
...
twitch_miner.mine(
    [
        ...
        Streamer("anomaly", settings=StreamerSettings(make_predictions=True , follow_raid=True  , claim_drops=True , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART , percentage=5 , stealth_mode=True, percentage_gap=20 , max_points=50000  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
